...
import com.deliveryapp.model.JwtUserResponse;
...
public class DeliveryMapper {
	...
	// for user
	public JwtUser toUserEntity(JwtUserRequest userRequest) {
		return mapper.map(userRequest,JwtUser.class);
	}
	public JwtUserResponse toUserResponse(JwtUser user) {
		return mapper.map(user,JwtUserResponse.class);
	}
