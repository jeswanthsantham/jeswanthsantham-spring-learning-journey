...
import com.deliveryapp.model.ApiUserResponse;
...
public class DeliveryMapper {
	...
	//for user
	public ApiUser toUserEntity(ApiUserRequest userRequest) {
		return mapper.map(userRequest, ApiUser.class);
	}
	public ApiUserResponse toUserResponse(ApiUser user) {
		return mapper.map(user, ApiUserResponse.class);
	}
